...
import com.starspath.justwalls.data.client.ModTagProvidor;
...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        gen.addProvider(event.includeServer(), new ModTagProvidor(packOutput, lookupProvider, existingFileHelper));
    }
}
